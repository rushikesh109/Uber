...
const ConfirmRidePopUp = (props) => {
  ...
  <h3 className="text-2xl font-semibold md-5">Confirm this ride to Start</h3>
...
className='w-full mt-2 flex text-lg justify-center bg-green-600 text-white font-semibold p-3 rounded-lg'>Confirm</Link>
  <button 
 onClick={() => {
 ...
 className='w-full mt-1 text-lg bg-red-600 text-white font-semibold p-3 rounded-lg'>Ignore</button>
</form>
</div>
 </div>
</div>
